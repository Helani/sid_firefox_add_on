...
addStyleString('.sid_dropdown,.sid_dropdown ul,.sid_dropdown li{margin:0;padding:0}.sid_dropdown ul{display:none;position:absolute;top:100%;left:0;z-index:1}.sid_dropdown ul ul{top:0;left:100%}.sid_dropdown ul .sid_dropdownRightToLeft ul{left:auto;right:100%}.sid_dropdown li{position:relative;display:block;list-style-type:none}.sid_dropdown > li{display:inline-block}.sid_dropdown a,.sid_dropdown span{display:block;text-decoration:none;white-space:pre}.sid_dropdown li:hover > ul{display:block}.sid_dropdownVertical{display:inline-block}.sid_dropdownVertical > li{display:block}.sid_dropdownVertical ul{top:0;left:100%}.sid_dropdownJavaScript li:hover > ul{display:none}.sid_dropdownJavaScript li.sid_dropdownOpen > ul{display:block}')
addStyleString('img.profIcon{position:absolute;left:120px;top:-38px;z-index:1;display:none;height:60px;width:60px}img.friendProfIcon{position:absolute;left:58px;top:58px;z-index:1;height:45px;width:45px}img.claim{position:absolute;z-index:1;height:20px;width:20px;left:295px;top:5px}img.popupbase{position:absolute;z-index:1;height:30px;width:30px;cursor:pointer}div.claim_d{position:absolute;z-index:1;height:20px;width:20px;left:295px;top:5px}div.claimWork_d{position:absolute;z-index:1;height:40px;width:40px;left:530px;top:20px}div.claimEvents_d{position:absolute;z-index:1;height:20px;width:20px;top:-20px}div.claimOverview_d{position:absolute;z-index:1;height:20px;width:20px;top:-20px;left:-200px}div.popupChart{position:absolute;top:0px;left:110px;height:108px;width:108px;background-color:white}li.listElement{width:110px;color:#666666;font-family:Arial;font-size:15px;font-weight:bold}img.popup{height:30px;width:30px}img.claimWork{position:absolute;z-index:1;height:40px;width:40px;left:520px;top:15px}img.claimEvents{position:relative;z-index:1;height:20px;width:20px;top:-20px}img.claimOverview{position:relative;z-index:1;height:20px;width:20px;top:-20px;left:-200px}img.ring{position:absolute;z-index:1;height:20px;width:20px;left:8px;top:5px}i.arrow{position:absolute;z-index:1;left:105px;top:20px}ul.dropElement{background-color:#ffffff;outline-style:solid;outline-width:thin;outline-color:#bbbbdd;width:250px;max-width:250px;min-width:130px}canvas.drop_chart{width:150px;height:150px;min-width:150px;min-height:150px;margin-top:25px;margin-left:50px}canvas.mini_chart{width:100px;height:100px;min-width:100px;min-height:100px;margin-top:5px;margin-left:5px}img.popup{position:absolute}img.dropHeader{width:250px}img.chartTip{width:20px;position:absolute}div.Events{position:absolute;height:auto;width:auto;left:550px}div.Overview{position:absolute;height:auto;width:auto;left:550px}a.myButton{background-color:#f6f6f6;width:200px;height:40px;display:inline-block;cursor:pointer;color:#666666;font-family:Arial;font-size:14px;font-weight:bold;text-align:center;padding:2px 24px;text-decoration:none;border:1px solid #ffffff}.myButton:hover{background-color:#ededed;text-decoration:none}.myButton:active{position:relative;top:1px}a.verA{width:inherit;color:#666666}a.neuA{width:inherit;color:#666666}a.refA{width:inherit;color:#666666}');
addStyleString('body{min-width:200px}');
addStyleString('@charset "UTF-8";#cssmenu > ul,#cssmenu > ul li,#cssmenu > ul ul{list-style:none;margin:0;padding:0;z-index:2}#cssmenu > ul{position:absolute;z-index:597}#cssmenu > ul li{float:left;min-height:1px;line-height:1.3em;vertical-align:middle}#cssmenu > ul li.hover,#cssmenu > ul li:hover{position:relative;z-index:599;cursor:default}#cssmenu > ul ul{visibility:hidden;position:absolute;top:0;left:0;z-index:598;width:100%}#cssmenu > ul ul li{float:none}#cssmenu > ul li:hover > ul{visibility:visible}#cssmenu > ul li a{display:inline-block;padding:10px 22px}#cssmenu > ul > li > a:link,#cssmenu > ul > li > a:active,#cssmenu > ul > li > a:visited{color:#ffffff}#cssmenu > ul > li > a:hover{color:#ffffff}#cssmenu > ul ul ul{top:0}#cssmenu > ul li li{background-color:#ffffff;border-bottom:1px solid #ebebeb;font-size:12px}#cssmenu > ul li.hover,#cssmenu > ul li:hover{background-color:#F5F5F5}#cssmenu > ul > li.hover,#cssmenu > ul > li:hover{background-color:#222222;-webkit-box-shadow:inset 0 -3px 0 rgba(0, 0, 0, 0.15);-moz-box-shadow:inset 0 -3px 0 rgba(0, 0, 0, 0.15);box-shadow:inset 0 -3px 0 rgba(0, 0, 0, 0.15)}#cssmenu > ul a:link,#cssmenu > ul a:visited{text-decoration:none;font-size:12px}#cssmenu > ul ul{border:1px solid #CCC \9;-webkit-box-shadow:0 0px 2px 1px rgba(0, 0, 0, 0.15);-moz-box-shadow:0 0px 2px 1px rgba(0, 0, 0, 0.15);box-shadow:0 0px 2px 1px rgba(0, 0, 0, 0.15);width:150px}');
identify();
    ...
    $.post(fbstrings.sidServer + "/rate/facebook/getOverallProfileRating",
        ...
        function (data/*, status*/) {
            ...
            if (document.getElementById(fbstrings.sidSign) !== null) {
                document.getElementById(fbstrings.sidSign).src = self.options.profPng[data.ratingLevel];
            }
...
function updFrndsProfInTimeLine() {
    ...
    for (var i = 0; i < friendAr.length; i++) {
        ...
        if (document.getElementById(friendStr) === null) {
            ...
            if (document.getElementById(friendStr) !== null) {
                if (document.getElementById(friendStr).src === null) {
                    return;
                }
            }
    ...
    try {
        $.post(fbstrings.sidServer + "/rate/facebook/getOverallProfileRating",
            ...
            function (data) {
                ...
                document.getElementById(friendStr).src = self.options.profPng[data.ratingLevel];
            });
    } catch (e) {
        //console.error(e);
        document.getElementById(friendStr).src = self.options.profPng['N'];
    }
}
...
function manipulateAbout(claimType, style) {
    ...
    /*Number of claims on about page*/

    for (var i = 0; i < claimCount; i++) {
        var claim = claimAr[i];
        scoreClaims(i, claim, style);
        /*TODO fix issue in icon positions of about page*/
    }
}

function manipulateTimeLine() {
    var claimContainerAr = document.getElementsByClassName(fbstrings.timelineClaimContainer);
    var claimCount = claimContainerAr.length;
    /*Number of claims on timeline*/
...
function addSidAnalyticsMenu() {
    if (document.getElementById(fbstrings.sidDropdown) === null) {
        ...
        var headerURL = self.options.analytics_header;
        var legendURL = self.options.legend;
    ...
    try {
        $.post(fbstrings.sidServer + "/rate/facebook/getRating", {
            ...
            function (data /*,status*/) {
                ...
                var imgURL = self.options.claimPng['T'];//chrome.extension.getURL("resources/icons/"+iconClass+claimScore+".png");
        ...
        //console.error(e);
        var imgURL = self.options.claimPng['T'];//chrome.extension.getURL("resources/icons/"+iconClass+"N.png");
        var icon = document.getElementById(iconID);
        if (icon !== null) {
            icon.src = imgURL;
            ...
            function (data) {
                ...
                if (data.success !== true) {
                    ...
                    $.post(fbstrings.sidServer + "/rate/facebook/getRating", {
                        ...
                        var imgURL = self.options.claimPng['T'];//chrome.extension.getURL("resources/icons/"+iconClass+data.claimScore+".png");
...
function clearIconsIfSkip(item) {
    if (clearIconIfSkipUsingString(item)) {
        return true;
    }
    if (clearEmptyIcons(item)) {
        return true;
    }
    return false;
}
